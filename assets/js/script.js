...
// Cấu hình Menu (đưa ra ngoài để không bị khai báo lại)
const leftMenuData = [{
    title: 'ADMIN',
    items: [{
        id: 'btnADMIN',
        ...
        subItems: [{
            id: 'btnDatabase',
            text: 'DATABASE',
            htmlFile: 'admin-database.html',
            pageTitle: '',
            icon: 'fa-solid fa-database'
        }, {
            id: 'btnUserInfo',
            text: 'THÔNG TIN USER',
            htmlFile: 'admin-user-info.html',
            pageTitle: '',
            icon: 'fa-solid fa-users'
        }, {
            id: 'btnThongBao',
            text: 'TẠO THÔNG BÁO MỚI',
            htmlFile: 'admin-thong-bao.html',
            pageTitle: '',
    ...
    items: [{
        ...
        subItems: [{
            id: 'btnWorkMT2',
            text: 'TRIỂN KHAI MIỀN TÂY 2',
            htmlFile: 'cv-trien-khai.html',
            pageTitle: '',
            icon: 'fa-solid fa-user-group'
        }, {
            id: 'btnBHXToiUu',
            text: 'BHX - TỐI ƯU THIẾT BỊ',
            htmlFile: 'cv-trien-khai-bhx.html',
            pageTitle: '',
        ...
        subItems: [{
            ...
            htmlFile: 'cv-monitor.html',
            pageTitle: '',
            icon: 'fa-solid fa-desktop'
        }, {
            id: 'btnCbs',
            text: 'BÁO CÁO CHÀO BUỔI SÁNG',
            htmlFile: 'cv-cbs.html',
            pageTitle: '',
            icon: 'fa-solid fa-circle-check'
        }, {
            id: 'btnTimSheet',
            text: 'TÌM KIẾM SHEET CÔNG VIỆC',
            htmlFile: 'tai-lieu-tim-sheet.html',
            pageTitle: 'ĐANG PHÁT TRIỂN',
            icon: 'fa-solid fa-folder-tree'
        }]
    }, {
        id: 'btnBTKK',
        text: 'LỊCH BẢO TRÌ - KIỂM KÊ',
        htmlFile: 'cv-bao-tri-kiem-ke.html',
        pageTitle: '',
        icon: 'fas fa-tools'
    }, {
        id: 'btnTimKiem',
        ...
        subItems: [{
            ...
            htmlFile: 'tim-kiem-sieu-thi.html',
            pageTitle: '',
            icon: 'fas fa-store-alt'
        }, {
            id: 'btnTimHangBK',
            text: 'TÌM HÀNG HÓA BACKUP',
            htmlFile: 'tim-kiem-hang-bk.html',
            pageTitle: '',
            icon: 'fas fa-box-open'
        }, {
            id: 'btnTraCuuFTTH',
            text: 'TRA CỨU FTTH',
            htmlFile: 'tra-cuu-ftth.html',
            pageTitle: '',
            icon: 'fa-solid fa-circle-check'
        }, {
            id: 'btnTaiLieu',
            text: 'TÌM TÀI LIỆU | LINK',
            htmlFile: 'tim-kiem-tai-lieu.html',
            pageTitle: '',
            icon: 'fa-solid fa-file'
        }, {
            id: 'btnTimDuAn',
            text: 'TÌM KIẾM DỰ ÁN',
            htmlFile: 'tai-lieu-du-an.html',
            pageTitle: 'ĐANG PHÁT TRIỂN',
            icon: 'fa-solid fa-circle-check'
        }, ]
    }]
    ...
    items: [{
        ...
        subItems: [{
            id: 'btnTGDD',
            text: 'TGDD & ĐMX',
            htmlFile: 'tai-lieu-tgdd-dmx.html',
            pageTitle: 'Thế Giới Di Động & Điện Máy Xanh',
            icon: 'fas fa-mobile-alt'
        }, {
            id: 'btnBachHoaXanh',
            text: 'BÁCH HÓA XANH',
            htmlFile: 'tai-lieu-bhx.html',
            pageTitle: '',
            icon: 'fas fa-store'
        }, {
            id: 'btnAvakid',
            text: 'AVAKID',
            htmlFile: 'tai-lieu-avakid.html',
            pageTitle: 'AvaKID',
            icon: 'fas fa-child'
        }, {
            id: 'btnAnKhang',
            text: 'AN KHANG',
            htmlFile: 'tai-lieu-an-khang.html',
            pageTitle: 'An Khang',
            icon: 'fas fa-pills'
        }, {
            id: 'btnKhoVp',
            text: 'KHO/VP',
            htmlFile: 'tai-lieu-kho-vp.html',
            pageTitle: 'Kho/VP',
        ...
        subItems: [{
            id: 'btnVPN',
            text: 'TẢI VPN',
            htmlFile: 'download-vpn.html',
            pageTitle: '',
            icon: 'fas fa-download'
        }, {
            id: 'btnDrive',
            text: 'DRIVE TÀI LIỆU',
            htmlFile: 'download-drive.html',
            pageTitle: '',
            icon: 'fas fa-download'
        }, ]
    }, {
        ...
        htmlFile: 'getPage_TaiLieuDashboard',
        pageTitle: 'BẢNG ĐIỀU KHIỂN CHÍNH - TEST',
...
const rightMenuData = [{
    ...
    items: [{
        text: "Báo Cáo Nội Bộ",
        href: "https://baocaonoibo.com",
        icon: "fas fa-chart-bar",
        className: "primary"
    }, {
        text: "Xwork",
        href: "https://newticket.tgdd.vn/ticket",
        icon: "fas fa-ticket-alt",
        className: "primary"
    }, {
        text: "Pfcontroller",
        href: "https://pfsense.tgdd.vn/",
        icon: "fa-solid fa-server",
        className: "primary"
    }, {
        text: "IOT",
        href: "https://iot.tgdd.vn/",
        ...
        text: "Cms App",
        href: "https://cmsapp.thegioididong.com/",
        icon: "fa-solid fa-ellipsis-vertical",
        className: "primary"
    }, {
        text: "POS BHX",
        href: "https://pos.bachhoaxanh.com/",
        icon: "fa-solid fa-ellipsis-vertical",
        className: "primary"
    }, ]
}, {
...
async function handleLogin(event) {
    ...
    try {
        ...
        const response = await callApi('handleLogin', {
            username,
            password,
            ipAddress
        });
...
async function handleSignup(event) {
    ...
    try {
        const response = await callApi('handleRegister', {
            username,
            password,
            fullName,
            phone
...
// --- Biến và hàm được định nghĩa ở scope này để dùng chung cho trang chính ---
...
// =================================================================================
// --- SỰ KIỆN DOMCONTENTLOADED (Điểm khởi chạy chính của ứng dụng) ---
// =================================================================================
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.location.pathname.includes('trang-chu.html')) {
        ...
        // --- Các hàm chỉ thuộc về trang chính ---
        ...
        function collapseSidebar(sidebarElement) {
            if (!isMobileView) sidebarElement.classList.add('collapsed');
            hideAllDropdowns();
        }

        function expandSidebar(sidebarElement) {
            if (!isMobileView) sidebarElement.classList.remove('collapsed');
        }
                    ...
                    if (item.isDropdown) {
                        ...
                        if (item.isAdmin) {
                            ...
                            dropdownButton.onmouseleave = () => {
                                if (!isMobileView) {
                                    dropdownTimeout = setTimeout(hideMenu, 300);
                                }
                            };
                            dropdownMenu.onmouseenter = () => clearTimeout(dropdownTimeout);
        ...
        async function loadFunctionContent(item) {
            ...
            try {
                ...
                if (item.htmlFile) {
                    ...
                    const response = await callApi('getPageContent', {
        ...
        async function handleStoreSuggestionInput(event) {
            ...
            try {
                const response = await callApi('getStoreSuggestions', {
                    partialCode: inputText
                });
        ...
        async function handleSearchStore() {
            ...
            try {
                const response = await callApi('searchStore', {
                    maST: maST
                });
        ...
        async function handleSearchHangBK() {
            ...
            loadingMessage.style.display = 'block';
            try {
                const results = await callApi('searchHangBK', {
                    maKho,
                    maUser
                });
        ...
        function updateClock() {
            ...
            if (dateElement) dateElement.textContent = now.toLocaleDateString('vi-VN', {
                weekday: 'long',
                day: 'numeric',
                month: 'long'
            });
        ...
        leftSidebarContainer.addEventListener('mouseleave', () => {
            if (!isSidebarPinned) collapseSidebar(leftSidebarContainer);
        });
        ...
        rightSidebarContainer.addEventListener('mouseleave', () => {
            if (!isSidebarPinned) collapseSidebar(rightSidebarContainer);
        });
